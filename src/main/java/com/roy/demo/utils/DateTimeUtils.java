...
//    
//    /** Formatter with: yyyy年M月d日 HH:mm **/
//    public final static int DATE_TYPE_04 = 7;
//
//    public final static String DF_FOR_SCHEDULE = "yyyy-MM-dd HH:mm:ss";
//
//    private final static SimpleDateFormat[] DATE_FORMATTER = new SimpleDateFormat[] { new SimpleDateFormat("MMM d, yyy"),
//            new SimpleDateFormat("EEE, MMM d, yyyy"), new SimpleDateFormat("MMM d, yyyy HH:mm:ss"),
//            new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss"), new SimpleDateFormat("yyyy/MM/dd") , new SimpleDateFormat("yy年M月d日") , new SimpleDateFormat("yyyy年M月d日") , new SimpleDateFormat("yyyy年M月d日 HH:mm") };
//
//    /**
//     * 
//     * @return
...
//    }
//
//	public static int diffDays(Date past, Date today) {
